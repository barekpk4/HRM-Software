...
namespace WebApiCore.Controllers.Attendance
{
    ...
    public partial class AttendenceApplicationController
    {
        ...
        public IActionResult GetDayOfShiftInfo(string startDate, string endDate, string shiftName)
        {
            Response response = new Response("/attendance/shiftAssign/getShiftDayInfo");
            try
            {
                var days = AttendenceApplication.GetDayOfShiftInfo(startDate, endDate, shiftName);
